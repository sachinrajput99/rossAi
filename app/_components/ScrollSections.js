...
const sections = [
    ...
    content: (
      <div className="grid gap-4">
        <p className="text-gray-300 mb-4">
          A direct and powerful competitor to Harvey&apos;s Word Add-in,
          operating seamlessly inside Microsoft Word—the primary work
  ...
  },
  {
    ...
    content: (
      <div className="grid gap-4">
        <p className="text-gray-300 mb-4">
          This feature mirrors the concept of Harvey&apos;s Vault but is
          tailored for the scale and needs of SME firms. It provides a
          centralized, encrypted, and easily navigable repository for all
          documents related to a specific case or matter.
        </p>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-md text-left">
          ...
          <ul className="text-gray-400 space-y-2 text-sm list-disc pl-5">
            ...
            <li>
              <span className="text-white">
                “Summarize our client&apos;s position from the initial
                complaint.”
              </span>
            </li>
          </ul>
      ...
      <div className="grid gap-4">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-md text-left">
          ...
          <p className="text-gray-300 text-sm mb-4">
            ...
            the legal profession&apos;s deep-seated skepticism towards
            AI-generated content and removes the fear of hallucinations.
          </p>
          <ul className="text-gray-400 space-y-2 text-sm list-disc pl-5">
            <li>
              <span className="text-white">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-md text-left">
          ...
          <ul className="text-gray-400 space-y-3 text-sm list-disc pl-5">
            ...
            <li>
              ...
              Position Ross as an embedded, indispensable part of the
              firm&apos;s operational workflow rather than a separate tool.
            </li>
          </ul>
        </div>
      </div>
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 shadow-md text-left space-y-5">
          <div>
            ...
            <p className="text-gray-300 text-sm">
              ...
              precedents. Attorneys can tailor arguments to align with a
              judge&apos;s history and preferences.
            </p>
          </div>
...
export default function ScrollSections() {
  ...
  // Use useRef once to hold all section refs
  const sectionRefs = useRef(
    Object.fromEntries(sections.map((s) => [s.value, React.createRef()]))
  );
    ...
    <div className="flex min-h-screen py-16 lg:py-40 w-full bg-black text-white">
      ...
      <div className="w-3/4 h-screen overflow-y-scroll snap-y snap-mandatory scroll-smooth scrollbar-hide">
        {sections.map((section) => (
          <section
            key={section.value}
            ref={sectionRefs.current[section.value]}
